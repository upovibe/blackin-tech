  ...
  return (
    <div onClick={onClose} className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div
        ...
        className="relative w-screen h-screen md:w-5/6 lg:w-4/6 xl:w-3/6 md:h-5/6 p-6 bg-white rounded-lg shadow-lg transition-transform transform scale-100 flex flex-col"
      >
        {/* Modal Header */}
